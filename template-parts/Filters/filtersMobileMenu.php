...
?>
    ...
    <?php
    $academicInstitutionFilter = array();
    $tagsFilter = array();
    $languagesFilter = array();
    $certificateFilter = array();

    foreach ($filters as $filterGroupId) {
        $filterType = get_field('filter_type', $filterGroupId);
//
//        switch ($filterType) {
//
//            case 'Academic Institutions':
//                array_push($academicInstitutionFilter,$filterGroupId);
//                break;
//
//            case 'Tags':
//                array_push($tagsFilter,$filterGroupId);
//                break;
//
//            case 'Languages':
//                array_push($languagesFilter,$filterGroupId);
//                break;
//
//            case 'Certificate':
//                array_push($certificateFilter,$filterGroupId);
//                break;
//        }

//    var_dump($academicInstitutionFilter);
//        var_dump($tagsFilter);
//    var_dump($languagesFilter);
//    var_dump($certificateFilter);
    }
//    console_log($academicInstitutionFilter);
//    console_log($tagsFilter);
//    console_log($languagesFilter);
//    console_log($certificateFilter);

   function getFilterGroup($filterGroupName){
