...
/*
 * Based on includes/fields/class-acf-academic-institution-relationship.php from
...
class acf_field_academic_nstitution extends acf_field {
    ...
    */
    ...
    function initialize() {
        ...
        // vars
        $this->name = 'relationship-academic-institution';
        $this->label = __("Relationship academic institution",'acf');
        ...
        // extra
        add_action('wp_ajax_acf/fields/relationship-academic-institution/query',			array($this, 'ajax_query'));
        add_action('wp_ajax_nopriv_acf/fields/relationship-academic-institution/query',	array($this, 'ajax_query'));
    ...
    */
    ...
    function input_admin_enqueue_scripts() {
        ...
        wp_register_script( 'acf-academic-institution', plugins_url(). '/acf-academic-institution-relationship/assets/src/input.js' , array( 'jquery' ), 1.2 );
        wp_enqueue_script('acf-academic-institution');
    ...
    */
    ...
    function get_ajax_query( $options = array() ) {
        ...
        $academic_institution = pods( 'academic_institution' );
        $academic_institution->find($params);

        while ($academic_institution->fetch()) { // academic_institution Loop

            $results[] = $this->get_post_result( $academic_institution->field('id'), $academic_institution->field('name'));
                ...
                <div class="values">
                    <ul class="acf-bl list values-list">
                        <?php if( !empty($field['value']) ):
                            ...
                            $posts = pods( 'academic_institution');
                            $posts->find($params);


                            while ($posts->fetch()) { // academic_institution Loop ?>
...
// initialize
new acf_field_academic_nstitution($this->settings);
?>
