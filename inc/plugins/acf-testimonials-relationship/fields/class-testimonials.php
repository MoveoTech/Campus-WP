...
/*
 * Based on includes/fields/class-acf-testimonials-relationship.php from
...
class acf_field_testimonials extends acf_field {
    ...
    */
    ...
    function initialize() {
        ...
        // vars
        $this->name = 'relationship-testimonials';
        $this->label = __("Relationship testimonials",'acf');
        ...
        // extra
        add_action('wp_ajax_acf/fields/relationship-testimonials/query',			array($this, 'ajax_query'));
        add_action('wp_ajax_nopriv_acf/fields/relationship-testimonials/query',	array($this, 'ajax_query'));
    ...
    */
    ...
    function input_admin_enqueue_scripts() {
        ...
        wp_register_script( 'acf-testimonials', plugins_url(). '/acf-testimonials-relationship/assets/src/input.js' , array( 'jquery' ), 1.2 );
        wp_enqueue_script('acf-testimonials');
    ...
    */
    ...
    function get_ajax_query( $options = array() ) {
        ...
        $testimonialsPods = pods( 'testimonial' );
        $testimonialsPods->find($params);

        while ($testimonialsPods->fetch()) { // testimonials Loop

            $results[] = $this->get_post_result( $testimonialsPods->field('id'), $testimonialsPods->field('name'));
                ...
                <div class="values">
                    <ul class="acf-bl list values-list">
                        <?php if( !empty($field['value']) ):
                            ...
                            $posts = pods( 'testimonial');
                            $posts->find($params);


                            while ($posts->fetch()) { // testimonials Loop ?>
...
// initialize
new acf_field_testimonials($this->settings);
?>
